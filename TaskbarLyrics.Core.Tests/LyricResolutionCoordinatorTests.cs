...
{
    [Fact]
    public async Task OnlineSelectionUsesFixedTrustOrderRegardlessOfCompletionOrderAndScore()
    {
        ...
        Assert.Equal("lyrics:QQMusic:Trust Song", resolved.Content.Lines[0].Text);
